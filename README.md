...
### Latest Release: [v1.0.12](https://github.com/romanesko/caddy-manager/releases/tag/v1.0.12)

**Pre-built binaries (single file, no external static needed):**
- **Linux AMD64**: [caddy-manager-linux-amd64.tar.gz](https://github.com/romanesko/caddy-manager/releases/download/v1.0.12/caddy-manager-linux-amd64.tar.gz)
- **Linux ARM64**: [caddy-manager-linux-arm64.tar.gz](https://github.com/romanesko/caddy-manager/releases/download/v1.0.12/caddy-manager-linux-arm64.tar.gz)
- **macOS AMD64**: [caddy-manager-darwin-amd64.tar.gz](https://github.com/romanesko/caddy-manager/releases/download/v1.0.12/caddy-manager-darwin-amd64.tar.gz)
- **macOS ARM64**: [caddy-manager-darwin-arm64.tar.gz](https://github.com/romanesko/caddy-manager/releases/download/v1.0.12/caddy-manager-darwin-arm64.tar.gz)
...
```bash
# Linux AMD64
wget https://github.com/romanesko/caddy-manager/releases/download/v1.0.12/caddy-manager-linux-amd64.tar.gz
mkdir -p caddy-manager && tar -xzf caddy-manager-linux-amd64.tar.gz -C caddy-manager
cd caddy-manager

# Linux ARM64
wget https://github.com/romanesko/caddy-manager/releases/download/v1.0.12/caddy-manager-linux-arm64.tar.gz
mkdir -p caddy-manager && tar -xzf caddy-manager-linux-arm64.tar.gz -C caddy-manager
cd caddy-manager

# macOS AMD64
wget https://github.com/romanesko/caddy-manager/releases/download/v1.0.12/caddy-manager-darwin-amd64.tar.gz
mkdir -p caddy-manager && tar -xzf caddy-manager-darwin-amd64.tar.gz -C caddy-manager
cd caddy-manager

# macOS ARM64
wget https://github.com/romanesko/caddy-manager/releases/download/v1.0.12/caddy-manager-darwin-arm64.tar.gz
