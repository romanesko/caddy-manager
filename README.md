...
- **macOS ARM64**: [caddy-manager-darwin-arm64.tar.gz](https://github.com/romanesko/caddy-manager/releases/download/v1.0.7/caddy-manager-darwin-arm64.tar.gz)
...
```bash
# Linux AMD64
wget https://github.com/romanesko/caddy-manager/releases/download/v1.0.7/caddy-manager-linux-amd64.tar.gz
tar -xzf caddy-manager-linux-amd64.tar.gz
cd caddy-manager-linux-amd64

# Linux ARM64
wget https://github.com/romanesko/caddy-manager/releases/download/v1.0.7/caddy-manager-linux-arm64.tar.gz
tar -xzf caddy-manager-linux-arm64.tar.gz
cd caddy-manager-linux-arm64

# macOS AMD64
wget https://github.com/romanesko/caddy-manager/releases/download/v1.0.7/caddy-manager-darwin-amd64.tar.gz
tar -xzf caddy-manager-darwin-amd64.tar.gz
cd caddy-manager-darwin-amd64

# macOS ARM64
wget https://github.com/romanesko/caddy-manager/releases/download/v1.0.7/caddy-manager-darwin-arm64.tar.gz
