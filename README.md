...
### Latest Release: [v1.0.5](https://github.com/romanesko/caddy-manager/releases/tag/v1.0.5)

**Pre-built binaries:**
- **Linux AMD64**: [caddy-manager-linux-amd64.tar.gz](https://github.com/romanesko/caddy-manager/releases/download/v1.0.5/caddy-manager-linux-amd64.tar.gz)
- **Linux ARM64**: [caddy-manager-linux-arm64.tar.gz](https://github.com/romanesko/caddy-manager/releases/download/v1.0.5/caddy-manager-linux-arm64.tar.gz)
- **macOS AMD64**: [caddy-manager-darwin-amd64.tar.gz](https://github.com/romanesko/caddy-manager/releases/download/v1.0.5/caddy-manager-darwin-amd64.tar.gz)
- **macOS ARM64**: [caddy-manager-darwin-arm64.tar.gz](https://github.com/romanesko/caddy-manager/releases/download/v1.0.5/caddy-manager-darwin-arm64.tar.gz)
...
```bash
# Linux AMD64
wget https://github.com/romanesko/caddy-manager/releases/download/v1.0.5/caddy-manager-linux-amd64.tar.gz
tar -xzf caddy-manager-linux-amd64.tar.gz
cd caddy-manager-linux-amd64

# Linux ARM64
wget https://github.com/romanesko/caddy-manager/releases/download/v1.0.5/caddy-manager-linux-arm64.tar.gz
tar -xzf caddy-manager-linux-arm64.tar.gz
cd caddy-manager-linux-arm64

# macOS AMD64
wget https://github.com/romanesko/caddy-manager/releases/download/v1.0.5/caddy-manager-darwin-amd64.tar.gz
tar -xzf caddy-manager-darwin-amd64.tar.gz
cd caddy-manager-darwin-amd64

# macOS ARM64
wget https://github.com/romanesko/caddy-manager/releases/download/v1.0.5/caddy-manager-darwin-arm64.tar.gz
